...
import me.mirosh.spiritualread.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    //bookId get from intent started from adapterPdfAdmin.class
    ...
    private static String TAG="BOOK_EDIT_TAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle click , go to prvoious screen
        ...
        refBooks.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Log.d(TAG, "onDataChange: Loading Book CategoryInfo");
                        DatabaseReference refCat=FirebaseDatabase.getInstance().getReference("Categories");
                        refCat.child(selectedCategoryId)
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        //get category
                                        String category=""+snapshot.child("category").getValue();
                                        //set to cateogry text view
...
private void updatePdf(){
    ...
    private  void categoryDialog(){
        ...
        builder.setTitle("Choose Cateogry")
    ...
    private void loadCategories() {
        Log.d(TAG, "loadCategories: Local categories ...");
