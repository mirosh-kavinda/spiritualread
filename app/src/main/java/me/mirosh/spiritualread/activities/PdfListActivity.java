...
import me.mirosh.spiritualread.databinding.ActivityPdfListBinding;
        ...
        ref.orderByChild("categoryId").equalTo(categoryId)
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterPdfAdmin=new AdapterPdfAdmin(PdfListActivity.this,pdfArrayList);
                        LinearLayoutManager manager = new LinearLayoutManager(PdfListActivity.this);
                        binding.bookRv.setAdapter(adapterPdfAdmin);
                        binding.bookRv.setLayoutManager(manager);
                    }
